...
const Post = ({ addToCart, product, variants }) => {
    ...
    const checkServiceability = async () => {
        let pins = await fetch('http://localhost:3004/api/pincode')
    ...
    const refreshVariant = (newsize,newcolor) =>{
        let url = `http://localhost:3004/product/${variants[newcolor][newsize]['slug']}`
        window.location = url
    }
        ...
        <section className="text-gray-600 body-font overflow-hidden">
            <div className="container px-5 py-16 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/51gtIqRpwOL._SX679_.jpg" />
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        <h2 className="text-sm title-font text-gray-500 tracking-widest">CODECOUTURE</h2>
                        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Style the code (XL/Blue)</h1>
                        ...
                        <div className="flex">
                            ...
                            <button onClick={() => { addToCart(slug, 1, 499, 'style the code(XL,Red)', 'XL', 'Red') }} className="flex ml-4 text-white bg-pink-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
                        ...
                        <div className="pin mt-6 flex space-x-2 text-sm">
                            <input onChange={onChangePin} className="px-2 border-2 border-gray-400 rounded-nd" type="text" placeholder='Enter your Pincode' />
